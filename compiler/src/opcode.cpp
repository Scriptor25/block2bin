...
bool b2b::IsEntryPoint(const OpcodeE opcode)
{
    static const std::set set
    {
    ...
    return set.contains(opcode);
}

std::ostream &b2b::operator<<(std::ostream &stream, const OpcodeE opcode)
{
    static const std::map<OpcodeE, const char *> map
    {
        { undefined, "undefined" },
